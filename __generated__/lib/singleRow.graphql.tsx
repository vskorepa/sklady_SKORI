/* 27c60c38678a6fa0c60a2684d256dad16612b6b7
...
export const AddSingleRowDocument = gql`
    mutation AddSingleRow($id: Int!, $name: String!, $code: String!, $description: String, $count: Int!) {
  AddSingleRow(
    id: $id
    name: $name
    code: $code
...
export const DeleteSingleRowDocument = gql`
    mutation DeleteSingleRow($id: Int!) {
  deleteSingleRow(id: $id) {
    id
  }
}
    `;
...
export const EditCountDocument = gql`
    mutation editCount($id: Int!, $count: Int!) {
  editCount(id: $id, count: $count) {
    id
    count
  }
}
